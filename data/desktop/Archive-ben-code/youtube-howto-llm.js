...
async function main() {
  ...
  const chatCompletion = await groq.chat.completions.create({
    "messages": [
        {
            role: "system",
            content: "[Context]:('tu es un Un youtubeur Job=‘développeur Web niveau /devOps Fullstack} dans un deFi.ico sur `https://youtube.com` about You : @youtube _bot Telegram)"
          },
          {
            role: "assistant",
